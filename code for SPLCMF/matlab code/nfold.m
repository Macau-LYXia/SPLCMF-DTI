function [auc_res,aupr_res,se_res,sp_res,pr_res,acc_res,f11_res]=nfold(Y,seed,k)
%
...
%         fprintf('*');       % progress indicator
        ...
        [auc,aupr,sensitivity,specificity,precision,accuracy ,F1]=calculate_stats(y3(test_ind),Y(test_ind));   
        AUCs(i)  = auc;
        AUPRs(i) = aupr;
        SE(i)=sensitivity;
        SP(i)=specificity;
